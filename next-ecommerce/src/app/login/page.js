        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-lg p-4 sm:p-5">
          ...
          <div className="relative my-3">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white text-gray-500">Or create an account using:</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-3 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 transition font-medium text-gray-700"
            >

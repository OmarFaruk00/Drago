    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-[9999]">
        <button
          ...
          className="relative flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg ring-2 ring-brand/20 hover:scale-105 hover:shadow-xl hover:ring-brand/40 transition-all duration-200"
        ...
        {/* WhatsApp icon badge - top of chat icon */}
        <div
          className="absolute -top-0.5 -right-0.5 w-6 h-6 rounded-full bg-[#25D366] flex items-center justify-center shadow-md ring-2 ring-white"
          aria-hidden
        >

        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 overflow-visible">
          <div className="flex items-center justify-between h-14 gap-4 overflow-visible">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {user?.avatar ? (
                  <img src={user.avatar} alt="" className="w-8 h-8 rounded-full object-cover shrink-0 border border-white/30" />
                ) : (
              ...
              >
                ...
                <span className="hidden sm:inline text-xs sm:text-sm font-medium whitespace-nowrap">Menu</span>
              </button>
            </div>
          </div>
